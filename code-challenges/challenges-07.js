...
const objLat = (obj) => {
    ...
    let first=obj.firstName[0].toUpperCase()+obj.firstName.slice(1);
    let last=obj.lastName[0].toUpperCase()+obj.lastName.slice(1);
...
const classesAvg = (data) => {
    ...
    for(let i=0;i<data.grades.length;i++){
        for(let j=0;j<data.grades.classes.length;j++){
